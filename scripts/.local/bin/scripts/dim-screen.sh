...
trap "set_brightness $(get_brightness); pidof dunst && killall -SIGUSR2 dunst #resume dunst; kill %%" EXIT
fade_brightness $min_brightness ; pidof dunst && killall -SIGUSR1 dunst #pause dunst
sleep 2147483647 &
wait
